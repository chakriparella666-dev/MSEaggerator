    ...
    return (
        <div style={{
            ...
            <div className="card" style={{ width: '450px', padding: '40px' }}>
                <h2 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '8px', textAlign: 'center' }}>Create Account</h2>
                <p style={{ color: 'var(--text-muted)', textAlign: 'center', marginBottom: '32px' }}>Join the MSE Aggregator platform</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, marginBottom: '6px' }}>Role</label>
                        <select
                            value={formData.role}
                            onChange={(e) => setFormData({ ...formData, role: e.target.value })}
                            style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid var(--border)' }}
                        >
                            <option value="owner">MSE Owner</option>
